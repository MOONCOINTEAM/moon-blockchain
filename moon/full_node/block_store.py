...
from moon.types.weight_proof import SubEpochChallengeSegment, SubEpochSegments
from moon.util.db_wrapper import DBWrapper2
from moon.util.errors import Err
from moon.util.full_block_utils import generator_from_block
    ...
    async def create(cls, db_wrapper: DBWrapper2):
        ...
        async with self.db_wrapper.writer_maybe_transaction() as conn:
            ...
            if self.db_wrapper.db_version == 2:
                ...
                # in the moon/cmds/db_upgrade.py file
