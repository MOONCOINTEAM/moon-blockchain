...
from moon.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from moon.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
from moon.types.weight_proof import (
...
def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="moon_full_node_weight_proof_handler_executor_shutdown_trigger")
