...
from moon.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "26988"
                testnet_introducer = "introducer-testnet0.mooncoin.top"
                testnet_dns_introducer = "dns-testnet0.mooncoin.top"
                bootstrap_peers = ["testnet0-node.mooncoin.top"]
                testnet = "testnet0"
                ...
                mainnet_port = "26888"
                mainnet_introducer = "introducer.mooncoin.top"
                mainnet_dns_introducer = "dns.mooncoin.top"
                bootstrap_peers = ["node.mooncoin.top"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running moon services for changes to take effect")
