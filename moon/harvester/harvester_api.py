...
from moon.harvester.harvester import Harvester
from moon.plotting.util import PlotInfo, parse_plot_info
from moon.protocols import harvester_protocol
from moon.protocols.farmer_protocol import FarmingInfo
from moon.protocols.harvester_protocol import Plot, PlotSyncResponse
from moon.protocols.protocol_message_types import ProtocolMessageTypes
from moon.server.outbound_message import make_msg
...
from moon.util.ints import uint8, uint32, uint64
from moon.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSMoonConnection
    ):
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSMoonConnection
    ):
        """
