...
from moon.util.errors import KeychainNotSet, KeychainMaxUnlockAttempts
...
DEFAULT_USER = f"user-moon-{CURRENT_KEY_VERSION}"  # e.g. user-moon-1.8
DEFAULT_SERVICE = f"moon-{DEFAULT_USER}"  # e.g. moon-user-moon-1.8
...
def obtain_current_passphrase(prompt: str = DEFAULT_PASSPHRASE_PROMPT, use_passphrase_cache: bool = False) -> str:
    ...
    before failing.
    """
    from moon.cmds.passphrase_funcs import prompt_for_passphrase
