...
from moon.data_layer.data_layer_errors import KeyNotFoundError
from moon.data_layer.data_layer_util import (
    DiffData,
    InternalNode,
    KeyValue,
    Layer,
...
from moon.data_layer.data_layer_wallet import DataLayerWallet, Mirror, SingletonRecord, verify_offer
from moon.data_layer.data_store import DataStore
from moon.data_layer.download_data import insert_from_delta_file, write_files_for_root
...
from moon.util.db_wrapper import DBWrapper
...
from moon.wallet.trading.offer import Offer as TradingOffer
...
class DataLayer:
    ...
    def set_server(self, server: MoonServer) -> None:
        self.server = server
