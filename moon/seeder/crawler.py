...
from moon.protocols import full_node_protocol
from moon.seeder.crawl_store import CrawlStore
from moon.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: ws.WSMoonConnection):
