...
from moon.rpc.wallet_rpc_api import WalletRpcApi
from moon.server.outbound_message import NodeType
from moon.server.start_service import RpcInfo, Service, async_run
from moon.types.peer_info import PeerInfo
from moon.util.moon_logging import initialize_logging
from moon.util.config import load_config_cli, load_config
...
from moon.wallet.wallet_node_api import WalletNodeAPI
...
async def async_main() -> int:
    ...
    if local_test is True:
        from moon.simulator.block_tools import test_constants
