...
class ConsensusConstants:
    ...
    # Forks of moon should change this value to provide replay attack protection
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M moon.
    MAX_COIN_AMOUNT: int
