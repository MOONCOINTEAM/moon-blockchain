...
from moon.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from moon.rpc.rpc_client import RpcClient
from moon.types.blockchain_format.sized_bytes import bytes32
from moon.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Moon RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
