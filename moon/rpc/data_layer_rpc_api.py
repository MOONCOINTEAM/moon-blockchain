...
from moon.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from moon.rpc.data_layer_rpc_util import marshal
...
from moon.util.streamable import recurse_jsonify
from moon.wallet.trading.offer import Offer as TradingOffer

if TYPE_CHECKING:
    from moon.data_layer.data_layer import DataLayer
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "moon_data_layer"
