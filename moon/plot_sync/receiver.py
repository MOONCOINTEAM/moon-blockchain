...
from moon.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from moon.plot_sync.exceptions import (
...
from moon.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
from moon.server.ws_connection import ProtocolMessageTypes, WSMoonConnection, make_msg
from moon.types.blockchain_format.sized_bytes import bytes32
from moon.util.ints import int16, uint32, uint64
from moon.util.misc import get_list_or_len
...
class Receiver:
    ...
    def connection(self) -> WSMoonConnection:
