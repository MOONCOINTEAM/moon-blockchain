...
from moon.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from moon.plot_sync.util import Constants
from moon.plotting.manager import PlotManager
from moon.plotting.util import PlotInfo
...
from moon.server.ws_connection import NodeType, ProtocolMessageTypes, WSMoonConnection, make_msg
from moon.util.generator_tools import list_to_batches
from moon.util.ints import int16, uint32, uint64
...
class Sender:
    ...
    _connection: Optional[WSMoonConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSMoonConnection) -> None:
