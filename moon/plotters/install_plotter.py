import os
from moon.plotters.bladebit import install_bladebit
from moon.plotters.madmax import install_madmax


def install_plotter(plotter, root_path):
    if plotter == "moonpos":
        print("Moonpos already installed. No action taken.")
        return
    elif plotter == "madmax":
        if not os.path.exists(root_path / "madmax-plotter/build/moon_plot"):
