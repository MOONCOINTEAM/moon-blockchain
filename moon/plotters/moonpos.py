"""
NOTE: This contains duplicate code from `moon.cmds.plots`.
After `moon plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_moonpos_install_info() -> Optional[Dict[str, Any]]:
    moonpos_version: str = pkg_resources.get_distribution("chiapos").version
    return {"display_name": "Moon Proof of Space", "version": moonpos_version, "installed": True}
