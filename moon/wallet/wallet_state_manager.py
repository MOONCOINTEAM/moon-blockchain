...
from moon.consensus.block_rewards import calculate_base_farmer_reward, calculate_pool_reward
from moon.consensus.coinbase import farmer_parent_id, pool_parent_id
from moon.consensus.constants import ConsensusConstants
from moon.data_layer.data_layer_wallet import DataLayerWallet
from moon.data_layer.dl_wallet_store import DataLayerStore
from moon.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH, solution_to_pool_state
from moon.pools.pool_wallet import PoolWallet
from moon.protocols import wallet_protocol
from moon.protocols.wallet_protocol import CoinState, PuzzleSolutionResponse, RespondPuzzleSolution
from moon.server.server import MoonServer
from moon.server.ws_connection import WSMoonConnection
from moon.types.blockchain_format.coin import Coin
from moon.types.blockchain_format.program import Program
from moon.types.blockchain_format.sized_bytes import bytes32
from moon.types.coin_spend import CoinSpend
...
from moon.util.byte_types import hexstr_to_bytes
from moon.util.db_synchronous import db_synchronous_on
from moon.util.db_wrapper import DBWrapper2
from moon.util.errors import Err
from moon.util.path import path_from_root
from moon.util.ints import uint8, uint32, uint64, uint128
from moon.util.lru_cache import LRUCache
from moon.wallet.cat_wallet.cat_constants import DEFAULT_CATS
from moon.wallet.cat_wallet.cat_utils import construct_cat_puzzle, match_cat_puzzle
from moon.wallet.cat_wallet.cat_wallet import CATWallet
from moon.wallet.derivation_record import DerivationRecord
from moon.wallet.derive_keys import (
...
from moon.wallet.did_wallet.did_wallet import DIDWallet
from moon.wallet.did_wallet.did_wallet_puzzles import DID_INNERPUZ_MOD, create_fullpuz, match_did_puzzle
from moon.wallet.key_val_store import KeyValStore
from moon.wallet.nft_wallet.nft_info import NFTWalletInfo
from moon.wallet.nft_wallet.nft_puzzles import get_metadata_and_phs, get_new_owner_did
from moon.wallet.nft_wallet.nft_wallet import NFTWallet
from moon.wallet.nft_wallet.uncurry_nft import UncurriedNFT
from moon.wallet.outer_puzzles import AssetType
from moon.wallet.puzzle_drivers import PuzzleInfo
from moon.wallet.puzzles.cat_loader import CAT_MOD, CAT_MOD_HASH
from moon.wallet.rl_wallet.rl_wallet import RLWallet
from moon.wallet.settings.user_settings import UserSettings
from moon.wallet.trade_manager import TradeManager
from moon.wallet.transaction_record import TransactionRecord
from moon.wallet.util.address_type import AddressType
from moon.wallet.util.compute_hints import compute_coin_hints
from moon.wallet.util.transaction_type import TransactionType
from moon.wallet.util.wallet_sync_utils import last_change_height_cs
from moon.wallet.util.wallet_types import WalletType
from moon.wallet.wallet import Wallet
from moon.wallet.wallet_action import WalletAction
from moon.wallet.wallet_action_store import WalletActionStore
from moon.wallet.wallet_blockchain import WalletBlockchain
from moon.wallet.wallet_coin_record import WalletCoinRecord
from moon.wallet.wallet_coin_store import WalletCoinStore
from moon.wallet.wallet_info import WalletInfo
from moon.wallet.wallet_interested_store import WalletInterestedStore
from moon.wallet.wallet_nft_store import WalletNftStore
from moon.wallet.wallet_pool_store import WalletPoolStore
from moon.wallet.wallet_puzzle_store import WalletPuzzleStore
from moon.wallet.wallet_sync_store import WalletSyncStore
from moon.wallet.wallet_transaction_store import WalletTransactionStore
from moon.wallet.wallet_user_store import WalletUserStore
...
class WalletStateManager:
    ...
    async def determine_coin_type(
        self, peer: WSMoonConnection, coin_state: CoinState, fork_height: Optional[uint32]
    ...
    async def filter_spam(self, new_coin_state: List[CoinState]) -> List[CoinState]:
        moc_spam_amount = self.config.get("moc_spam_amount", 1000000)

        # No need to filter anything if the filter is set to 1 or 0 mojos
        if moc_spam_amount <= 1:
            return new_coin_state

        spam_filter_after_n_txs = self.config.get("spam_filter_after_n_txs", 200)
        small_unspent_count = await self.coin_store.count_small_unspent(moc_spam_amount)
        ...
        for cs in new_coin_state:
            ...
            if (
                ...
                and cs.coin.amount < moc_spam_amount
