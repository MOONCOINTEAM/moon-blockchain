...
from moon.cmds.init_funcs import moon_init
...
from moon.simulator.block_tools import make_unfinished_block
...
class FakeServer:
    ...
    def get_full_node_outgoing_connections(self) -> List[ws.WSMoonConnection]:
        return []
...
async def run_sync_test(
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        moon_init(root_path, should_check_keys=False, v1_db=(db_version == 1))
        ...
        try:
            ...
            peer: ws.WSMoonConnection = FakePeer()  # type: ignore[assignment]
...
async def run_sync_checkpoint(
    ...
    moon_init(root_path, should_check_keys=False, v1_db=False)
    config = load_config(root_path, "config.yaml")
