...
rm -rf ../venv || true
rm -rf venv || true
rm -rf moon_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf moon-blockchain-gui/build || true
rm -rf moon-blockchain-gui/daemon || true
rm -rf moon-blockchain-gui/node_modules || true
rm moon-blockchain-gui/temp.json || true
( cd "$PWD/moon-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
