...
# Gets the version from the result of "moon version"
...
def get_moon_version() -> str:
    version: str = "0.0"
    output = subprocess.run(["moon", "version"], capture_output=True)
...
if __name__ == "__main__":
    update_version(f"{os.path.dirname(__file__)}/moon-blockchain-gui/package.json")
    update_version(f"{os.path.dirname(__file__)}/moon-blockchain-gui/packages/gui/package.json")
